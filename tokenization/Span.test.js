...
module.exports.tests.setBody = (test) => {
  ...
  test('setBody: trim text when greater than 140 characters with spaces', (t) => {
    const span = new Span(`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
  ...
  test('setBody: do not trim text when it\'s 140 characters', (t) => {
    const span = new Span('LoremipsumdolorsitametconsecteturadipiscingelitseddoeiusmodtemporincididuntutlaboreetdoloremagnaaliquaUtenimadminimveniamquisnostrudexercita')
    t.equals(span.start, 0)
    t.equals(span.end, 140)
    t.end()
  })
